...
if __name__ == "__main__":
    ...
    st.set_page_config(
        ...
        get_img_base64("icon_blue_square_v2.png"),
        initial_sidebar_state="expanded",
        menu_items={
            "Get Help": "https://github.com/space/Langchain-Chatchat",
            "Report a bug": "https://github.com/space/Langchain-Chatchat/issues",
    ...
    with st.sidebar:
        st.image(
            get_img_base64("logo-long-trans-v2.png"), use_column_width=True
        )
        st.caption(
